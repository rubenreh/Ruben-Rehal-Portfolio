    ...
    <div class="w-full md:w-3/5 h-20 mx-auto md:mt-5">
        <div class="bg-white rounded-xl mx-3 p-5 md:p-10 md:mx-0">
            <div>
                ...
                <div class="mt-3 text-left text-gray-800 text-sm">Published on <span>{{ date }}</span></div>
...
export default {
    ...
    methods: {
        async getDetails() {
            ...
            axios.get('https://665f887f5425580055b00a73.mockapi.io/updates/' + id) //this is under ruben.rehal@gmail.com
                .then(response => {
